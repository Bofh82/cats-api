...
kubectl wait deployment -n default pf-analytic-service --for condition=Available=True --timeout=60s
...
kubectl wait deployment -n default pf-analytic-service --for condition=Available=False --timeout=60s
