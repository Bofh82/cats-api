...
kubectl wait deployment -n default $1 --for condition=Available=True --timeout=60s
...
kubectl wait deployment -n default $1 --for condition=Available=False --timeout=60s
